...
import edu.fullerton.AcademyAdvisorAppointment.ejb.LocationFacade;
...
public class LocationController implements Serializable {
    ...
    @EJB
    private edu.fullerton.AcademyAdvisorAppointment.ejb.LocationFacade ejbFacade;
    ...
    public static class LocationControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Location) {
                ...
                return getStringKey(o.getLocation());
            } else {
